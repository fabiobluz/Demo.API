...
namespace ngDemoConsumoAPI.Controllers
{
    ...
    public class DemoController : Controller
    {
            ...
            using (var client = new HttpClient())
            {
                ...
                if (respToken.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    if (token.Authenticated)
                    {
                        ...
                        amigos = BuscaAmigos(client, 1, 4, 3);
                    }
                }
            }
        ...
        private static List<Amigo> BuscaAmigos(HttpClient client, int amigoId, double latitude, double longitude)
        {
            var url = String.Format("{0}AmigosPerto/LocalizaAmigos/{1}/{2}/{3}", _urlBase, amigoId, latitude, longitude);
